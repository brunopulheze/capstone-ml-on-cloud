        ...
        <div className="btc-card">
          ...
          <div className="btc-model-grid">
            {[
              ...
              ["Feature count", "25"],
              ["Test RMSE", driftReport?.retrained && driftReport?.new_rmse != null ? `≈ ${fmtUSD(driftReport.new_rmse)}` : driftReport?.baseline_rmse != null ? `≈ ${fmtUSD(driftReport.baseline_rmse)}` : "≈ $1,918"],
